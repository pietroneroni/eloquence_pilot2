    ...
    def instruct(self, dialog, utterance):
        ...
        if self._contains_any_question(last_counselor, self.RIASEC_QUESTIONS):
            ...
            return (
                ...
                "- Reply as the student to the counselor's last message.\n"
                f"- Answer ONLY the counselor's question directly, {lang_phrase}.\n"
                "- Use ONLY details consistent with your BACKGROUND, INTERESTS, PERSONALITY TRAITS, and PERSONAL RULES.\n"
                "- Choose the attitude semantically from the student's profile: the activity may feel appealing, mixed, or unappealing.\n"
