# Start Open WebUI SDialog counselor - MALE
# Run from PowerShell: .\start_owui_male.ps1
...
$env:OWUI_AGENT_PORT = "1333"
$env:OWUI_MODEL_ID = "university-counselor-male:latest"
$env:OWUI_FORCED_GENDER = "male"
...
Write-Host "Starting MALE counselor server..." -ForegroundColor Cyan
